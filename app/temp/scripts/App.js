            ...
            this.itemsToReveal.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler() {
                        //what to do when it scrol to this element

                        (0, _jquery2.default)(curruntItem).addClass("reveal-item--is-visible");
                    },
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction == "down") {
                            ...
                            (0, _jquery2.default)(matchingHeaderLink).addClass("is-curruntlink");
                        }
                    },
                    offset: "18%"
                });
